import { CloseOutlined, WalletOutlined } from '@comunion/icons'
...
const UAddressInput = defineComponent({
  ...
  setup(props, ctx) {
    ...
    return () => (
      ...
      >
        {{
          prefix: () => <WalletOutlined class="u-address-input__icon" />,
          suffix: () =>
            disabled.value ? <CloseOutlined class="u-address-input__close" onClick={reset} /> : null
        }}
      </UInput>
    )
  }
